    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (!Validations.isInteger(id)) {
                ...
                if (productQty <= 0) {
                    // Quantity must ne grater than 0
                    response_DTO.setContent("Invalid quantity."); 
                        ...
                        if (request.getSession().getAttribute("user") != null) {
                            ...
                            if (criteria2.list().isEmpty()) {
                                ...
                                if (productQty <= product.getQty()) {
                                    ...
                                    response_DTO.setContent("Quantity not avaliavable.");
                                ...
                                if (cartItem.getQty() + productQty <= product.getQty()) {
                                    ...
                                    //can't update cart product qty not avaliavable
                                    response_DTO.setContent("Can't update cart product qty not avaliavable.");
            ...
            e.printStackTrace();
            response_DTO.setContent("Please try again later.");
        }
